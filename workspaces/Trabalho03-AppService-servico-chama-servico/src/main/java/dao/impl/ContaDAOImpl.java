...
public class ContaDAOImpl implements ContaDAO {
	...
	public void altera(Conta umaConta) throws ObjetoNaoEncontradoException {
		try {
			EntityManager em = JPAUtil.getEntityManager();
	...
	public Conta recuperaUmaConta(long id) throws ObjetoNaoEncontradoException {
		try {
			EntityManager em = JPAUtil.getEntityManager();
	...
	public Conta recuperaUmaContaComLock(long id) throws ObjetoNaoEncontradoException {
		try {
			EntityManager em = JPAUtil.getEntityManager();
	...
	public List<Conta> recuperaContas() {
		try {
			...
			List<Conta> contas = em.createQuery("select c from Conta c " + "order by c.id asc").getResultList();
